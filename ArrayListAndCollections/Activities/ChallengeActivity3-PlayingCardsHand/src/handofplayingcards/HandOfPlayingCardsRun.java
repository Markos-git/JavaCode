...
public class HandOfPlayingCardsRun {
   ...
   public static void main(String[] args) { 
       ...
       System.out.printf("Your Hand(%d)\t: %s  Remaining Deck(%d) : %s\n",
               hand.cardCount(), hand.toString(), deck.cardCount(), deck.toString());
       
       System.out.printf("Pair of Queens?\t%s\n", hand.rankCount(Ranks.QUEEN) == 2);
       System.out.printf("Three kings in hand: \t%s\n", hand.rankCount(Ranks.KING) == 3);
   }
