...
public class StudentGradeStrategyRun {
    ...
    public static void main(String[] args) {
        ...
        students.add(new Student("Ana", 65, new LetterGradeStrategy()));
        students.add(new Student("Milos",50 , new PassFailStrategy()));
        students.add(new Student("Marko",92 , new LetterGradeStrategy()));
        students.add(new Student("Milica",85 , new PassFailStrategy()));
